...
def eingabeformular():
    with st.form("eingabe_formular"):
        ...
        with col2:
            ...
            annahme_wertsteigerung = st.slider("Wertsteigerung der Immobilie pro Jahr (%)", -5, 5, value=0, step=0.1, help="Nominal = OHNE Einbezug von Inflation. --> Nominal, also ohne Berücksichtigung der Inflation, stiegen die Immobilienpreise in Deutschland seit 1975 um etwa 215 %. Das entspricht einer durchschnittlichen jährlichen Steigerung von ungefähr 2,7 %. ")
            annahme_inflation = = st.slider("Inflation pro Jahr (%)", -5, 5, value=1.0, step=0.1, help="")
